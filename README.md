...
实际工作流案例会跟着用户实操一起沉淀。当前版本（v0.1）暂不内置固定案例，字段说明与运行策略见 [WorkflowGenerator 文档站](https://github.com/qxryz/workflowgenerator) 的 `/#troubleshooting` 和 `/#run` 页面（文档站代码在独立仓 `qxryz/workflowgenerator`）。
...
文档站（Vite + React）独立成仓：[`qxryz/workflowgenerator`](https://github.com/qxryz/workflowgenerator)。
...
更完整的字段说明、内容块模板和排障表见 [WorkflowGenerator 文档站](https://github.com/qxryz/workflowgenerator) 的 `/docs` 页面。
