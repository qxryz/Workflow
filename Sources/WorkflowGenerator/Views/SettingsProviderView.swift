                            ...
                            Button {
                                ...
                                HStack(spacing: 10) {
                                    Image(systemName: provider.symbolName)
                                        .frame(width: 18)
                                        .foregroundStyle(provider.id == resolvedSelectedProviderId ? .pink : .secondary)
                                    Text(provider.name)
                                        .lineLimit(1)
                                    Spacer(minLength: 0)
                                }
                                ...
                                .padding(.vertical, 7)
                                .background(provider.id == resolvedSelectedProviderId ? Color.secondary.opacity(0.18) : Color.clear, in: RoundedRectangle(cornerRadius: 7))
                            }
                            .buttonStyle(.plain)
                        }
                    }
